...
export default function ProjectDetailPage() {
  ...
  if (!project) {
    return (
      <div className="min-h-screen flex items-center justify-center py-[4em] sm:py-[6em]">
        <div className="container mx-auto px-[1em] sm:px-[2em] text-center">
          <h1 className="text-[3em] font-bold text-gradient-animated mb-[1em]">
            Project Not Found
          </h1>
          <p className="text-[1.2em] text-foreground/60 mb-[2em]">
            The project you're looking for doesn't exist.
          </p>
          <Link
            href="/works"
            className="glass-button inline-flex items-center gap-[0.5em] px-[1.5em] py-[0.75em]"
          >
            <ArrowLeft className="w-[1.2em] h-[1.2em]" />
            Back to Projects
          </Link>
        </div>
      </div>
  ...
  const progressData = [
    {
      name: "Completion",
      value: 100, // Default to 100% if not specified
    ...
    <div className="min-h-screen py-[4em] sm:py-[6em]">
      <div className="container mx-auto px-[1em] sm:px-[2em]">
        ...
        <Reveal>
          <Link
            href="/works"
            className="glass-button inline-flex items-center gap-[0.5em] mb-[2em] px-[1em] py-[0.5em] transition-all hover:scale-105"
          >
            <ArrowLeft className="w-[1.2em] h-[1.2em]" />
            Back to Projects
          </Link>
        ...
        {/* Main Content */}
        <div className="glass-strong rounded-[1.5em] border border-white/10 p-[1.5em] sm:p-[2.5em] shadow-2xl">
          {/* Image Carousel */}
          <Reveal>
          ...
          <Reveal>
            <div className="mb-[2em]">
              <div className="mb-[1em] flex flex-wrap items-start justify-between gap-[1em]">
                <div>
                  <h1 className="text-gradient-animated mb-[0.5em] text-[2.5em] font-bold leading-tight">
                    {project.name}
                  </h1>
                ...
                <div className="flex flex-wrap gap-[0.5em]">
                  <span
                    className="glass-card rounded-[0.5em] px-[0.75em] py-[0.25em] text-[0.85em] font-medium border"
                    style={{
